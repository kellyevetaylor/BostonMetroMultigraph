...
public class MetroMapParser
{
     ...
     * @throws com.company.BadFileException if there is a problem with the format of the file
     *
            ...
            throws IOException, BadFileException
    {
        ...
        //TODO: Hardcoded size, need to figure it out before creating the graph
        Graph graph = new Graph(125);
...
//            System.out.format("Station ID: %s\nStation name: %s\n", stationID, stationName);
...
//                System.out.format("Line name: %s; OutboundID: %s; InboundID: %s\n", lineName, outboundID, inboundID);
                graph.addEdge(stationID, inboundID);
                graph.addEdge(stationID, outboundID);
            }
