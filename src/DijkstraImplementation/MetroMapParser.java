...
public class MetroMapParser
{
    ...
    private static void usage()
    {
        ...
        System.out.println("java ex3.DijkstraImplementation.MetroMapParser <filename>");
    }
     ...
     *
     * @returns a new DijkstraImplementation.MetroMapParser that will parse the file filename
     */
